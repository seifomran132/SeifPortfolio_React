...
function ContactDetails(props) {
    return (
        <div className="left col-md-4 col-xs-12">
              <h3>Contact</h3>
              <p>
                If you have a question or business inquiry don't hesitate to
                contact us, we will have the honer to work with you
              </p>
              ...
              <div className="social-media">
                <a href="https://github.com/seifomran132" className="github">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <a
                  href="https://www.linkedin.com/in/seif-omran-053b60142/"
                  className="linkedin"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://wa.me/+201015796783" className="whatsapp">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
